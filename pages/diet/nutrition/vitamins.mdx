...
<Head>
    <title>Vitamins | Guy Guide</title>
    <meta
        name="description"
        content="Vitamins and it's importance in men's health"
    />
    <meta
        property="og:description"
        content="Guy Guide | Vitamins"
    />
</Head>

# Vitamins

![Vitamins in a healthy diet](/diet/vitamins.png)
